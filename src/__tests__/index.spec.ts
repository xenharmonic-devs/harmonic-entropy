...
describe('Harmonic entropy calculator (class)', () => {
  ...
  it('can be serialized', () => {
    ...
    expect(serialized).toBe(
      '{"type":"EntropyCalculator","options":{"N":1000,"res":100},"tableY":[1.0406308287245427,2.957849276572092,2.8025290882335474,2.7199329429047627,2.679974909320833,2.569745315189403,2.7927280401803567,2.3836319835863327,2.762985167803323,2.6175492942407934,2.7652522430326556,2.896296296715723,1.6851019186072065,2.89058975083966,2.7231137316080005,2.731079581152761,2.5822264414027614,2.759003908365329,2.8244326764802286,1.9969824142681423,2.856604716635028,2.705878630795079,2.601114664162786,2.7912880810361584,2.1317590374418924]}',
    );
  });
